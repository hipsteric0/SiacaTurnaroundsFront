      ...
      y[index.id] = (
        <div key={index.id} className={styles.tableInfoRow}>
          ...
          >
            <div className={styles.dialogBack}>
            <div className={styles.dialogText}>
              <div className={styles.warningIcon}><CheckCircleOutlineIcon color="success" fontSize="inherit"/></div>
              <p><strong>¿Está seguro que desea aceptar este usuario?</strong></p>
              <br/>
              <div className={styles.dialogButtons}>
              <GreenButton2
                executableFunction={() => {
          ...
          >
            <div className={styles.dialogBack}>
            <div className={styles.dialogText}>
              <div className={styles.warningIcon}><BlockIcon color="error" fontSize="inherit"/></div>
              <p><strong>¿Está seguro que desea rechazar a este usuario?</strong></p>
              <br/>
              <div className={styles.dialogButtons}>
              <GreenButton2
                executableFunction={() => {
